...
let virtual-env = "/home/overlord/Projects/a-time-to-plant/.venv"
let bin = "bin"
let path-sep = ":"
...
let virtual_prompt = (if ("a-time-to-plant" != "") {
    "(a-time-to-plant) "
} {
...
alias deactivate = source "/home/overlord/Projects/a-time-to-plant/.venv/bin/deactivate.nu"
